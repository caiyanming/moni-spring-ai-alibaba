...
/**
 * Observation documentation for DashScope speech synthesis operations.
 */
public enum SpeechSynthesisObservationDocumentation implements ObservationDocumentation {

	SPEECH_SYNTHESIS_OPERATION {
		@Override
		public Class<? extends ObservationConvention<? extends Observation.Context>> getDefaultConvention() {
			return DefaultSpeechSynthesisObservationConvention.class;
		}
